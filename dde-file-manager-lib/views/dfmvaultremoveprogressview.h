...
class DFMVaultRemoveProgressView : public DDialog
{
    Q_OBJECT
public:
     ...
     */
    void removeVault(const QString &vaultPath);
...
private slots:
    ...
    void onRemoveFinish(bool result);

private:
    QProgressBar *m_vaultRmProgressBar;
