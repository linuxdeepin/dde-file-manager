...
DAnythingMonitor::DAnythingMonitor(const QString& hookPath)
...
void DAnythingMonitor::doWork()
{
    ...
    TagManager::instance()->deleteFiles(QList<QString>::fromStdList(m_filesForDelete));
