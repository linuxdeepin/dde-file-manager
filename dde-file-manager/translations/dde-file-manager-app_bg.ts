...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Файловият мениджър е инструмент за управление на файлове разработен самостоятелно от Deepin Technology с възможност за търсене, копиране, кошче, компресиране / декомпресиране, свойства на файла и други функции за управление на файлове.</translation>
    </message>
</context>
</TS>