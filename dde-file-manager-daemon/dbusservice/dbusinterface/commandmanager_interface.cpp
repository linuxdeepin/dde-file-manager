...
/*
 * Implementation of interface class CommandManagerInterface
 */

CommandManagerInterface::CommandManagerInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
