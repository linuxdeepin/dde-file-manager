...
void QuickSearchDaemonAdaptor::fileWereDeleted(const QDBusVariant &file_list)
{
    // handle method call com.deepin.filemanager.daemon.QuickSearchDaemon.fileWereDeleted
    QMetaObject::invokeMethod(parent(), "fileWereDeleted", Q_ARG(QDBusVariant, file_list));
}

void QuickSearchDaemonAdaptor::fileWereRenamed(const QDBusVariant &old_and_new)
{
    // handle method call com.deepin.filemanager.daemon.QuickSearchDaemon.fileWereRenamed
    QMetaObject::invokeMethod(parent(), "fileWereRenamed", Q_ARG(QDBusVariant, old_and_new));
}
