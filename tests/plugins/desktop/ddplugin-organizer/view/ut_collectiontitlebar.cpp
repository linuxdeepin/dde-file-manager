...
TEST_F(CollectionTitleBarPrivateTest, modifyTitleName)
{
    ...
    Dtk::Widget::DStackedWidget *widget = new Dtk::Widget::DStackedWidget();
    titleBar.d->nameWidget = widget;
    Dtk::Widget::DLineEdit *edit = new Dtk::Widget::DLineEdit();
...
{
    stub_ext::StubExt stub;
    OptionButton *but = new OptionButton;
    ...
    QPaintEvent *event = new QPaintEvent(QRect(1,1,2,2));
