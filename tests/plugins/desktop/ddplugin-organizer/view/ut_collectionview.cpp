...
{
    CollectionView *res = new CollectionView("uuid",nullptr);
    ...
    data->setUrls(list);
    QDropEvent *event = new QDropEvent(QPointF(),Qt::CopyAction,data ,
...
TEST_F(TestCollectionView, continuousSelection)
{
    ...
    QPersistentModelIndex *newCurrent = new QPersistentModelIndex(newIndex);
    ...
    QPersistentModelIndex *oldCurrent = new  QPersistentModelIndex(oldIndex);
...
{
    QItemSelectionModel *itemModel = new QItemSelectionModel;
    auto fun_type = static_cast<QItemSelectionModel*(QAbstractItemView::*)()const>
    ...
    TestSourceModel *model = new TestSourceModel;
    view->setModel(model);
    QItemSelection *select1 = new QItemSelection;
    QItemSelection *select2 = new QItemSelection;
...
TEST_F(TestCollectionView, mouseMoveEvent)
{
    ...
    QMouseEvent *event1 =new QMouseEvent(QMouseEvent::MouseMove,
                                        QPointF(),QPointF(),QPointF(),
                                          Qt::LeftButton, Qt::LeftButton,
                                        Qt::ShiftModifier, Qt::MouseEventSynthesizedByQt);
    QMouseEvent *event2 =new QMouseEvent(QMouseEvent::MouseMove,
                                        QPointF(),QPointF(),QPointF(),
...
TEST_F(TestCollectionView, keyPressEvent)
{
   ...
   stub.set_lamda((fun_type)(&CollectionView::moveCursor),[](QAbstractItemView::CursorAction cursorAction,
                   Qt::KeyboardModifiers modifiers)->QModelIndex{
        __DBG_STUB_INVOKE__
        return QModelIndex();
    });
   ...
   QKeyEvent *event1 = new QKeyEvent(QEvent::KeyPress, Qt::Key_Space, Qt::NoModifier,"", true);
   event1->k = Qt::Key_F1;
   ...
   QKeyEvent *event2 = new QKeyEvent(QEvent::KeyPress, Qt::Key_Space, Qt::KeypadModifier,"", true);
   ...
   QKeyEvent *event3 = new QKeyEvent(QEvent::KeyPress, Qt::Key_Space, Qt::AltModifier,"", true);
   event3->k = Qt::Key_M;
   view->keyPressEvent(event3);
   EXPECT_TRUE(mCall);
   QKeyEvent *event4 = new QKeyEvent(QEvent::KeyPress, Qt::Key_Space, Qt::ShiftModifier,"", true);
   ...
   QKeyEvent *event5 = new QKeyEvent(QEvent::KeyPress, Qt::Key_Space, Qt::ControlModifier,"", true);
   event5->k = Qt::Key_A;
...
TEST_F(TestCollectionView, startDrag)
{
    ...
    QModelIndexList *res = new QModelIndexList;
...
TEST_F(TestCollectionView, dragMoveEvent)
{
    ...
    QMimeData *data = new QMimeData();
    QDragMoveEvent *event = new QDragMoveEvent(QPoint(),Qt::CopyAction,data,Qt::LeftButton,Qt::ShiftModifier);
