...
TEST_F(TestNormalizedMode, layout)
{
    ...
    CollectionHolderPointer holder_ptr1 = CollectionHolderPointer(new CollectionHolder("uuid",nullptr));
    CollectionHolderPointer holder_ptr2 = CollectionHolderPointer(new CollectionHolder("uuid",nullptr));
...
TEST_F(TestNormalizedMode, onFileInserted)
{
    ...
    QModelIndex *parent = new QModelIndex(1,1,nullptr,new TestSourceModel);
    int first = 1;
    int last = 1;
