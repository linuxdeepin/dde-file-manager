...
protected:
    virtual void SetUp() override
    {
        ...
        manager = new CanvasManager(new QObject);
...
TEST_F(UT_BoxSelector, updateCurrentIndex)
{
    ...
    QModelIndex *resIndex=new QModelIndex(0, 0, (void *)nullptr, new TestItemModel);
    ...
    resIndex = new QModelIndex(0, 0, (void *)nullptr, nullptr);
    bs->updateCurrentIndex();
...
{
    QModelIndex *leftIndex = new QModelIndex();
    QModelIndex *bottomIndex = new QModelIndex();
    QItemSelection *newSelection = new QItemSelection(*leftIndex,*bottomIndex);
    EXPECT_NO_FATAL_FAILURE(bs->selection(newSelection));

    CanvasProxyModel* md = new CanvasProxyModel(new QObject);
