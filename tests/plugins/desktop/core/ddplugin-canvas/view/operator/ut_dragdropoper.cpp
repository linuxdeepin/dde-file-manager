...
TEST_F(DragDropOperTest, move)
{
    ...
    stub.set_lamda((fun_type)(&CanvasView::indexAt),[](const QPoint&){
        __DBG_STUB_INVOKE__
        QModelIndex res(0, 0, (void *)nullptr, new TestItemModel);
        return res;
    });
    ...
    stub.set_lamda(&CanvasView::model,[](){
        __DBG_STUB_INVOKE__
                return new CanvasProxyModel();
    });
    ...
    QDragMoveEvent *event = new QDragMoveEvent(QPoint(1,1),Qt::CopyAction,data,Qt::LeftButton,Qt::ShiftModifier);
...
TEST_F(DragDropOperTest, drop)
{
    ...
    view.d->hookIfs = new ViewHookInterface;
    QMimeData *data = new QMimeData;
    QDropEvent *event = new QDropEvent(QPointF(),Qt::CopyAction,data , Qt::LeftButton,Qt::ControlModifier);
...
TEST_F(DragDropOperTest, dropBetweenView)
{
    ...
    QModelIndex *index = new QModelIndex(0,0, (void *)nullptr, new TestItemModel);
    typedef QModelIndex(*fun_type)(const QPoint&);
    ...
    CanvasProxyModel *mdModel = new CanvasProxyModel(nullptr);
    CanvasSelectionModel *smModel = new CanvasSelectionModel(mdModel,nullptr);
    ...
    QModelIndex *indexModel = new QModelIndex;
...
TEST_F(DragDropOperTest, dropMimeData)
{
    ...
    QModelIndex index(1, 1, (void *)nullptr, new TestItemModel);
    typedef QModelIndex(*fun_type)(const QPoint&);
...
TEST_F(DragDropOperTest, dragDropOperTest)
{
    ...
    QDragMoveEvent *dmoveEvent = new QDragMoveEvent(QPoint(1,1),Qt::CopyAction,data,Qt::LeftButton,Qt::ShiftModifier);
    bool calltryDodge = false;
    ...
    stub.set_lamda((fun_type1)(&CanvasView::indexAt),[](const QPoint&){
        __DBG_STUB_INVOKE__
        QModelIndex res(0, 0, (void *)nullptr, new TestItemModel);
        return res;
    });
