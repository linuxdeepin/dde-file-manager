...
TEST_F(UT_ViewPainter, drawDodge)
{
    ...
    QModelIndex rootIndex = QModelIndex(1, 1, nullptr,new TestItemModel());
...
TEST_F(UT_ViewPainter, polymerize)
{
    ...
    QModelIndex index1(1,1,nullptr,new TestItemModel);
    QModelIndex index2(2,2,nullptr,new TestItemModel);
    ...
    CanvasViewPrivate *d = new CanvasViewPrivate(view);

    QPixmap res = painter->polymerize(indexs,d);
