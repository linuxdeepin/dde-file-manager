...
DDE_FILE_MANAGER_LIB_FILTER_PATH=$FILTER_SYMBOL$PROJECT_FOLDER/dde-file-manager-lib/tests/$FILTER_SYMBOL$PROJECT_FOLDER/dde-file-manager-lib/3rdParty/$FILTER_SYMBOL$PROJECT_FOLDER/dde-file-manager-lib/search/fsearch/$FILTER_SYMBOL$PROJECT_FOLDER/dde-file-manager-lib/vault/openssl/$FILTER_SYMBOL$PROJECT_FOLDER/dde-file-manager-lib/vault/qrencode/
...
# 打印cppcheck命令
echo "cppcheck --enable=all --output-file="$REPORT_FILE_PATH "--xml" $DDE_DESKTOP_FILTER_PATH $DDE_FILE_MANAGER_FILTER_PATH $DDE_FILE_MANAGER_LIB_FILTER_PATH $DDE_FILE_MANAGER_DAEMON_FILTER_PATH $DDE_FILE_MANAGER_PLUGINS_FILTER_PATH $DDE_DOCK_PLUGINS_FILTER_PATH $DDE_FILE_THUMBNAIL_TOOL_FILTER_PATH $DEEPIN_ANYTHING_SERVER_PLUGINS_FILTER_PATH $OTHER_FILTER_PATH $PROJECT_FOLDER
# 执行cppcheck命令
