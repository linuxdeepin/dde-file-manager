...
void ComputerPropertyDialog::iniUI()
{
    ...
    computerName->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerVersionNum->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerEdition->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerOSBuild->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerType->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerCpu->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
    ...
    computerMemory->setRightFontSizeWeight(DFontSizeManager::T8, QFont::ExtraLight);
