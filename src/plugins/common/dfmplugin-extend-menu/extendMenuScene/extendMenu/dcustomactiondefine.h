...
static const QLatin1String kConfCombo("X-DDE-FileManager-MenuTypes");
static const QLatin1String kConfComboAlias("X-DFM-MenuTypes");
static const QLatin1String kConfMimeType("MimeType");
static const QLatin1String kConfExcludeMimeTypes("X-DDE-FileManager-ExcludeMimeTypes");
static const QLatin1String kConfExcludeMimeTypesAlias("X-DFM-ExcludeMimeTypes");
static const QLatin1String kConfSupportSchemes("X-DDE-FileManager-SupportSchemes");
static const QLatin1String kConfSupportSchemesAlias("X-DFM-SupportSchemes");
static const QLatin1String kConfNotShowIn("X-DDE-FileManager-NotShowIn");   // "Desktop", "Filemanager"
static const QLatin1String kConfNotShowInAlias("X-DFM-NotShowIn");
static const QLatin1String kConfSupportSuffix("X-DDE-FileManager-SupportSuffix");   // for deepin-compress *.7z.001,*.7z.002,*.7z.003...
static const QLatin1String kConfSupportSuffixAlias("X-DFM-SupportSuffix");
...
static const QLatin1String kActionPos("X-DDE-FileManager-PosNum");
static const QLatin1String kActionPosAlias("PosNum");
static const QLatin1String kActionSeparator("X-DDE-FileManager-Separator");
static const QLatin1String kActionSeparatorAlias("Separator");
