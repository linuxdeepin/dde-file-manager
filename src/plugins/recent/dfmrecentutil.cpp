...
Q_GLOBAL_STATIC(DFMRecentUtil, _recentUntil)

DFMRecentUtil::DFMRecentUtil()
...
QList<BookmarkNode> DFMRecentUtil::loadRecentFile() {
...
DFMRecentUtil &DFMRecentUtil::instance()
{
    return *_recentUntil;
}
