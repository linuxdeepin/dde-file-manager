...
private:
    DTK_WIDGET_NAMESPACE::DPasswordEdit *pwdEdit { Q_NULLPTR };
    QPushButton *tipsBtn { Q_NULLPTR };
    DTK_WIDGET_NAMESPACE::DToolTip *tooltip { Q_NULLPTR };
    DTK_WIDGET_NAMESPACE::DFloatingWidget *floatWidget { Q_NULLPTR };
};
}
