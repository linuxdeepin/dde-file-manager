...
QSet<QString> loadHideFileListFromPath(const QString &dirPath)
{
...
QSet<QString> SortFileInfoUtils::loadHideFileList(const QString &dirPath)
{
    return loadHideFileListFromPath(dirPath);
}
