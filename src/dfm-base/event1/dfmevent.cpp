...
DFMEvent::Type DFMEvent::type() const
{
    return static_cast<Type>(m_type);
}

void DFMEvent::setType(DFMEvent::Type type)
{
    m_type = type;
}

QPointer<const QObject> DFMEvent::sender() const
{
    return m_sender;
}

void DFMEvent::setSender(const QObject *sender)
{
    m_sender = sender;
}
...
void DFMEvent::accept()
{
    m_accept = true;
}

void DFMEvent::ignore()
{
    m_accept = false;
}
...
QList<QUrl> DFMEvent::handleUrlList() const
{
    QList<QUrl> list = qvariant_cast<QList<QUrl>>(m_data);

    if (list.isEmpty()) {
        const QUrl &url = qvariant_cast<QUrl>(m_data);
...
void DFMEvent::setData(const QVariant &data)
{
    m_data = data;
}
...
DFMUrlBaseEvent::DFMUrlBaseEvent(const QObject *sender, const QUrl &url)
    : DFMUrlBaseEvent(DFMEvent::UnknowType, sender, url)
{

}

DFMUrlBaseEvent::DFMUrlBaseEvent(DFMEvent::Type type, const QObject *sender, const QUrl &url)
...
{
    return dMakeEventPointer<DFMUrlBaseEvent>(type, Q_NULLPTR, QUrl::fromUserInput(json["url"].toString()));
}

DFMUrlListBaseEvent::DFMUrlListBaseEvent()
    : DFMUrlListBaseEvent(nullptr, QList<QUrl>())
{

}

DFMUrlListBaseEvent::DFMUrlListBaseEvent(const QObject *sender, const QList<QUrl> &list)
    : DFMUrlListBaseEvent(DFMEvent::UnknowType, sender, list)
{

}

DFMUrlListBaseEvent::DFMUrlListBaseEvent(DFMEvent::Type type, const QObject *sender, const QList<QUrl> &list)
    : DFMEvent(type, sender)
{
...
QSharedPointer<DFMUrlListBaseEvent> DFMUrlListBaseEvent::fromJson(Type type, const QJsonObject &json)
{
    ...
    for (const QJsonValue &value : json["urlList"].toArray()) {
        list << QUrl::fromUserInput(value.toString());
    }

    return dMakeEventPointer<DFMUrlListBaseEvent>(type, Q_NULLPTR, list);
}

DFMOpenFileEvent::DFMOpenFileEvent(const QObject *sender, const QUrl &url)
...
DFMOpenFileByAppEvent::DFMOpenFileByAppEvent(const QObject *sender, const QString &appName, const QUrl &url)
...
{
    return dMakeEventPointer<DFMOpenFileByAppEvent>(Q_NULLPTR, json["appName"].toString(), QUrl::fromUserInput(json["url"].toString()));
}

DFMOpenFilesByAppEvent::DFMOpenFilesByAppEvent(const QObject *sender, const QString &appName, const QList<QUrl> &url, const bool isEnter)
...
DFMCompressEvent::DFMCompressEvent(const QObject *sender, const QList<QUrl> &list)
...
DFMDecompressEvent::DFMDecompressEvent(const QObject *sender, const QList<QUrl> &list)
...
DFMDecompressHereEvent::DFMDecompressHereEvent(const QObject *sender, const QList<QUrl> &list)
...
DFMRenameEvent::DFMRenameEvent(const QObject *sender, const QUrl &from, const QUrl &to, const bool silent)
    : DFMEvent(RenameFile, sender)
{
    setData(QPair<QUrl, QUrl>(from, to));
    setProperty(QT_STRINGIFY(DFMRenameEvent::silent), silent);
}

QList<QUrl> DFMRenameEvent::handleUrlList() const
{
    const auto &&d = qvariant_cast<QPair<QUrl, QUrl>>(m_data);

    return QList<QUrl>() << d.first << d.second;
}
...
{
    return dMakeEventPointer<DFMRenameEvent>(Q_NULLPTR, QUrl::fromUserInput(json["from"].toString()), QUrl::fromUserInput(json["to"].toString()));
}

DFMDeleteEvent::DFMDeleteEvent(const QObject *sender, const QList<QUrl> &list, bool silent, bool force)
...
DFMMoveToTrashEvent::DFMMoveToTrashEvent(const QObject *sender, const QList<QUrl> &list, bool silent, const QList<QUrl> &cutList)
...
DFMRestoreFromTrashEvent::DFMRestoreFromTrashEvent(const QObject *sender, const QList<QUrl> &list)
...
QUrl DFMPasteEvent::targetUrl() const
{
    return property(QT_STRINGIFY(DFMPasteEvent::targetUrl), QUrl());
}

QList<QUrl> DFMPasteEvent::handleUrlList() const
{
    return QList<QUrl>() << targetUrl() << urlList();
}
...
QSharedPointer<DFMPasteEvent> DFMPasteEvent::fromJson(const QJsonObject &json)
{
    ...
    return dMakeEventPointer<DFMPasteEvent>(Q_NULLPTR, (DFMGlobal::ClipboardAction)json["action"].toInt(),
                                            QUrl::fromUserInput(json["targetUrl"].toString()), event->urlList());
}

DFMMkdirEvent::DFMMkdirEvent(const QObject *sender, const QUrl &url)
...
DFMTouchFileEvent::DFMTouchFileEvent(const QObject *sender, const QUrl &url)
...
DFMOpenFileLocation::DFMOpenFileLocation(const QObject *sender, const QUrl &url)
...
DFMAddToBookmarkEvent::DFMAddToBookmarkEvent(const QObject *sender, const QUrl &url)
    : DFMUrlBaseEvent(AddToBookmark, sender, url)
{

}

DFMRemoveBookmarkEvent::DFMRemoveBookmarkEvent(const QObject *sender, const QUrl &url)
    : DFMUrlBaseEvent(RemoveBookmark, sender, url)
{

}

DFMCreateSymlinkEvent::DFMCreateSymlinkEvent(const QObject *sender, const QUrl &fileUrl, const QUrl &toUrl, bool force/* = false*/)
...
QList<QUrl> DFMCreateSymlinkEvent::handleUrlList() const
{
    return QList<QUrl>() << url() << toUrl();
}

QSharedPointer<DFMCreateSymlinkEvent> DFMCreateSymlinkEvent::fromJson(const QJsonObject &json)
{
    const QSharedPointer<DFMCreateSymlinkEvent> &event = dMakeEventPointer<DFMCreateSymlinkEvent>(Q_NULLPTR, QUrl::fromUserInput(json["fileUrl"].toString()),
                                                                                                  QUrl::fromUserInput(json["toUrl"].toString()));
    event->setProperty(QT_STRINGIFY(DFMDeleteEvent::force), json["force"].toBool());
    return event;
}

DFMFileShareEvent::DFMFileShareEvent(const QObject *sender, const QUrl &url,
...
{
    return dMakeEventPointer<DFMFileShareEvent>(Q_NULLPTR, QUrl::fromUserInput(json["url"].toString()), json["name"].toString(),
                                                json["isWritable"].toBool(), json["allowGuest"].toBool());
}

DFMCancelFileShareEvent::DFMCancelFileShareEvent(const QObject *sender, const QUrl &url)
...
DFMOpenInTerminalEvent::DFMOpenInTerminalEvent(const QObject *sender, const QUrl &url)
...
DFMGetChildrensEvent::DFMGetChildrensEvent(const QObject *sender, const QUrl &url, const QStringList &nameFilters,
...
QSharedPointer<DFMGetChildrensEvent> DFMGetChildrensEvent::fromJson(const QJsonObject &json)
{
    ...
    return dMakeEventPointer<DFMGetChildrensEvent>(Q_NULLPTR, QUrl::fromUserInput(json["url"].toString()),
                                                   nameFilters, (QDir::Filters)json["filters"].toInt(), QDirIterator::NoIteratorFlags,
                                                   json["silent"].toBool());
}

DFMCreateDiriterator::DFMCreateDiriterator(const QObject *sender, const QUrl &fileUrl, const QStringList &nameFilters,
...
DFMCreateGetChildrensJob::DFMCreateGetChildrensJob(const QObject *sender, const QUrl &url, const QStringList &nameFilters,
...
DFMCreateFileInfoEvent::DFMCreateFileInfoEvent(const QObject *sender, const QUrl &url)
...
DFMCreateFileWatcherEvent::DFMCreateFileWatcherEvent(const QObject *sender, const QUrl &url)
...
DFMChangeCurrentUrlEvent::DFMChangeCurrentUrlEvent(const QObject *sender, const QUrl &url, const QWidget *window)
...
{
    return dMakeEventPointer<DFMChangeCurrentUrlEvent>(Q_NULLPTR, QUrl::fromUserInput(json["url"].toString()), Q_NULLPTR);
}

DFMOpenNewWindowEvent::DFMOpenNewWindowEvent(const QObject *sender, const QList<QUrl> &list, bool force)
...
DFMOpenNewTabEvent::DFMOpenNewTabEvent(const QObject *sender, const QUrl &url)
...
DFMOpenUrlEvent::DFMOpenUrlEvent(const QObject *sender, const QList<QUrl> &list, DFMOpenUrlEvent::DirOpenMode mode, const bool isEnter)
...
DFMMenuActionEvent::DFMMenuActionEvent(const QObject *sender, const DFileMenu *menu, const QUrl &currentUrl,
                                       const QList<QUrl> &selecteQUrls, DFMGlobal::MenuAction action, const QModelIndex &index)
    : DFMUrlListBaseEvent(MenuAction, sender, selecteQUrls)
{
...
const QUrl DFMMenuActionEvent::currentUrl() const
{
    return property(QT_STRINGIFY(DFMMenuActionEvent::currentUrl), QUrl());
}

const QList<QUrl> DFMMenuActionEvent::selecteQUrls() const
{
...
QSharedPointer<DFMMenuActionEvent> DFMMenuActionEvent::fromJson(const QJsonObject &json)
{
    ...
    event->setProperty(QT_STRINGIFY(DFMMenuActionEvent::currentUrl), QUrl::fromUserInput(json["currentUrl"].toString()));
...
DFMSetFileTagsEvent::DFMSetFileTagsEvent(const QObject *sender, const QUrl &url, const QList<QString> &tags)
...
DFMRemoveTagsOfFileEvent::DFMRemoveTagsOfFileEvent(const QObject *sender, const QUrl &url, const QList<QString> &tags)
...
DFMChangeTagColorEvent::DFMChangeTagColorEvent(const QObject *sender, const QColor &color, const QUrl &tagUrl)
...
DFMGetTagsThroughFilesEvent::DFMGetTagsThroughFilesEvent(const QObject *sender, const QList<QUrl> &files)
...
DFMSetFileExtraProperties::DFMSetFileExtraProperties(const QObject *sender, const QUrl &url, const QVariantHash &ep)
...
DFMSetPermissionEvent::DFMSetPermissionEvent(const QObject *sender, const QUrl &url, const QFileDevice::Permissions &permissions)
...
DFMOpenFilesEvent::DFMOpenFilesEvent(const QObject *sender, const QList<QUrl> &list, const bool isEnter)
