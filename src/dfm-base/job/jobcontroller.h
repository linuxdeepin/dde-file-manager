...
public:
    ...
    explicit JobController(const QUrl &fileUrl, const DAbstractDirIteratorPointer &iterator, bool silent = false, QObject *parent = nullptr);
    explicit JobController(const QUrl &fileUrl, const QStringList &nameFilters,
...
private:
    bool m_silent;
    DAbstractDirIteratorPointer m_iterator;
    QUrl m_fileUrl;
