...
public:
    ...
    bool start() override;
    bool stop() override;
    bool handleGhostSignal(const QUrl &targetUrl, DAbstractFileWatcher::SignalType1 signal, const QUrl &arg1) override;
    bool handleGhostSignal(const QUrl &targetUrl, DAbstractFileWatcher::SignalType2 signal, const QUrl &arg1, const QUrl &arg2) override;
...
bool DFileWatcherPrivate::handleGhostSignal(const QUrl &targetUrl, DAbstractFileWatcher::SignalType1 signal, const QUrl &arg1)
{
...
bool DFileWatcherPrivate::handleGhostSignal(const QUrl &targetUrl, DAbstractFileWatcher::SignalType2 signal, const QUrl &arg1, const QUrl &arg2)
{
...
DFileWatcher::DFileWatcher(const QString &filePath, QObject *parent)
    : DAbstractFileWatcher(*new DFileWatcherPrivate(this), QUrl::fromLocalFile(filePath), parent)
{
