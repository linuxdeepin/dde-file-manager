...
{
public:
    explicit DFMInfoCachesManagerPrivate(DFMInfoCachesManager *qq);
    ~DFMInfoCachesManagerPrivate();
    ...
    Q_DECLARE_PUBLIC(DFMInfoCachesManager)
};
