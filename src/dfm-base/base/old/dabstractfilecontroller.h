...
public:
    ...
    virtual QList<QUrl> moveToTrash(const QSharedPointer<DFMMoveToTrashEvent> &event) const;
    virtual QList<QUrl> pasteFile(const QSharedPointer<DFMPasteEvent> &event) const;
    ...
    virtual DFileDevice *createFileDevice(const QSharedPointer<DFMUrlBaseEvent> &event) const;
    virtual DFileHandler *createFileHandler(const QSharedPointer<DFMUrlBaseEvent> &event) const;
    virtual DStorageInfo *createStorageInfo(const QSharedPointer<DFMUrlBaseEvent> &event) const;
