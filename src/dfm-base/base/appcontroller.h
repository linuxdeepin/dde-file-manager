...
#include "dfm-base/base/private/subscriber.h"
...
//    void showTagEdit(const QRect &parentRect, const QPoint &globalPos, const QList<QUrl> &fileList);
...
private:
    ...
    static QPair<QUrl, quint64> selectionAndRenameFile;        //###: for creating new file.
    static QPair<QUrl, quint64> selectionFile;                //###: rename a file which must be existance.
...
public:
    static QPair<QList<QUrl>, quint64> multiSelectionFilesCache;  //###: for multi selection.
