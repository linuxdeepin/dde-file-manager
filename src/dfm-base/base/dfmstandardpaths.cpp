...
QString DFMStandardPaths::iconName(DFMStandardPaths::StandardLocation type)
{
    switch (type) {
    case HomePath:
        return "user-home";
...
QString DFMStandardPaths::displayName(DFMStandardPaths::StandardLocation type)
{
    switch (type) {
    case HomePath:
...
QString DFMStandardPaths::fromStandardUrl(const QUrl &url)
{
