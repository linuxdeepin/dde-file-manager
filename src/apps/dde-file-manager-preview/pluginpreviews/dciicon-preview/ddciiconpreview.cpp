...
void DDciIconPreview::initControlWidgets()
{
    ...
    availableSizeCombo->setAccessibleName("AvailableSizeCombo");
    ...
    customSizeEdit->setAccessibleName("CustomSizeEdit");
    ...
    themeCom->setAccessibleName("ThemeCom");
    ...
    modeCom->setAccessibleName("ModeCom");
    ...
    foregroundPaletteEdit->setAccessibleName("ForegroundPaletteEdit");
    ...
    backgroundPaletteEdit->setAccessibleName("BackgroundPaletteEdit");
    ...
    hightlightPaletteEdit->setAccessibleName("HightlightPaletteEdit");
    ...
    hFPaletteEdit->setAccessibleName("HFpaletteEdit");
