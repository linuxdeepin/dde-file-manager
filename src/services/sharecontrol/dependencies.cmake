# dependencies.cmake - Dependencies configuration for sharecontrol service
# This file defines the specific dependencies and configuration for the share control service
...
# Function to setup sharecontrol-specific DBus interfaces
function(dfm_setup_sharecontrol_dbus_interfaces target_name)
    message(STATUS "DFM: Setting up sharecontrol DBus interfaces for: ${target_name}")
    
    # Define the DBus interface file path using DFM_ASSETS_DIR
    set(DBUS_INTERFACE_FILE "${DFM_ASSETS_DIR}/dbus/org.deepin.Filemanager.ShareControl.xml")
    
    # Check if the DBus interface file exists
    if(EXISTS "${DBUS_INTERFACE_FILE}")
        message(STATUS "DFM: Found ShareControl DBus interface file: ${DBUS_INTERFACE_FILE}")
        ...
        if(ADAPTOR_SOURCES)
            ...
            message(STATUS "DFM: Added ShareControl DBus adaptor sources to target")
        endif()
    else()
        message(WARNING "DFM: ShareControl DBus interface file not found: ${DBUS_INTERFACE_FILE}")
    endif()
endfunction()

message(STATUS "DFM: Share control service dependencies configuration loaded") 