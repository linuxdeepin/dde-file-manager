...
Prerequisites: PC and mobile terminal must be connected to the same WLAN and within the same network segment. 

After the network connection is successful, then perform the following steps.

1. Click ![icon](../common/phone.svg) in the system tray or open File Manager and click **My Phone** in the left panel.
2. Click **Scan and Connect**, a window with a QR code inside pops up.

![phone](fig/myphone1.png)

3. Open UnionTech OS Assistant on your phone, click "Scan and Connect" and scan the QR code that pops up in Step 2. After the connection is successful, you can transfer and manager files.

If you need to disconnect, you can:

   - Click ![icon](../common/exit.svg) in UnionTech OS Assistant on your phone.
   - Right-click ![icon](../common/phone.svg) in the system tray on PC, select your phone and click **Disconnect**.

### Transfer files
After the connection between the mobile phone and PC is successful, files can be managed easily.

#### On phones

Click "Transfer Assistant" in UnionTech OS Assistant on your phone to send phone files to computer or to receive computer files.

View, download or share computer files in the "My Computer" interface in UnionTech OS Assistant on your phone.

#### On PCs

In **My Phone** interface, the phone folders will be categorized and displayed, you can open, edit and manage the files in your phone, and save the edited files directly to your phone; in the "History" area on the right side, you can send files from your computer to your phone, or receive phone files. 
