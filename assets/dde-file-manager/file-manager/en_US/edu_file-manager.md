...
![1|overview](fig/edu_overview.png)
...
![1|maininterface](fig/edu_maininterface.png)
...
![0|rename](fig/edu_contextmenu.png)
...
![1|batch_rename](fig/edu_rename.png)
...
![1|colortag](fig/edu_colortag.png)
...
2. Select **Open as administrator**, input your login password in the pop-up window and click **Confirm**.
3. The file will be opened in a new window, in which you can operate with administrator permissions. And you will exit administrator permissions when you close this window.
...
![0|openinterminal](fig/edu_openinterminal.png)
...
UnionTech OS Assistant is a practical tool to realize cross terminal cooperation and efficient transmission between mobile phone and computer. It only needs to connect the mobile phone and PC with the same WLAN to easily transfer files (including pictures, videos, files, etc) and edit files in the phone and save synchronically.

### Install UnionTech OS Assistant

1. Click ![icon](../common/phone.svg) in the system tray or open File Manager and click **My Phone** in the left panel.
...
PC and mobile terminal must be connected to the same WLAN. In case of a desktop computer, it should have a wireless network card inserted in advance.
...
3. Open UnionTech OS Assistant on your phone, scan the QR code and connect. After the connection is successful, you can transfer and manager files.
>![notes](../common/notes.svg)Notes: To disconnect, you can click ![icon](../common/exit.svg) in UnionTech OS Assistant on your phone or right-click ![icon](../common/phone.svg) in the system tray on PC, select your phone and click **Disconnect**.

### Transfer files
After the connection between the mobile phone and PC is successful, files can be transferred to each other. And files on mobile phone could be managed easily.

#### Manage phone files from PC

In the **File Manager > My Phone** interface, the phone folders will be categorized and displayed, you can view and manage the files in your phone, or edit the phone files in your computer and save them directly to your phone; in the "Transfer History" area on the right, you can send files from your computer to your phone, or receive phone files. Click ![icon](../common/more.svg) on the top right corner to view recent files or empty the history.

![pic](fig/phone_interface.png)

#### View PC files from phone

On the mobile side you can not only transfer files to your computer, but also view the computer files.

   - Open "Transfer Assistant" in UnionTech OS Assistant on your phone to send phone files to computer or to receive computer files. Click ![icon](../common/more.svg) on the top right corner to view recent files or empty the history.
   - View, download or share computer files in the "My Computer" interface in UnionTech OS Assistant on your phone.
...
![0|disk](fig/edu_rename_disk.png)
