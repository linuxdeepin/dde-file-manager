...
1. 在电脑中打开统信UOS助手。单击左侧导航栏的 **我的手机** 进入统信UOS助手界面；或单击系统托盘中的图标 ![icon](../common/assistant.svg) ，选择 **我的手机** 。
...
您也可以在电脑中，右键单击需要发送的文件，选择 **发送到我的手机** 即可发送。
...
>
> 从电脑发文件到手机/电脑时，同一WiFi下不一定为同一网段。同一WiFi下找不到投送的设备时，请在设备中登录同一Union ID后重试。
