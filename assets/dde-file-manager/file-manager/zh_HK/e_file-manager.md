...
>![notes](../common/notes.svg)說明：如果文件有標記，則複製或剪切該文件產生的文件仍然具有同樣的標記。
...
1. 單擊檔案管理員導航欄中 ![file_vault](../common/file_vault.svg) 圖標，或者在計算機界面雙擊 「我的保險箱」，在彈出的保險箱對話框中單擊 **建立**。 
...
5. 在彈出的完成加密對話框中單擊 **確定** ，設置完成後可將文件放入保險箱中。
...
3. 在彈出的認證對話框中輸入用戶登錄密碼，單擊 **確定** 完成刪除操作。
