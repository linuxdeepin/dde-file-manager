...
{
    // SetUp calls createFrame(), so frame is NOT nullptr
...
{
    // SetUp calls createFrame(), so widget is NOT nullptr
...
{
    // SetUp calls createFrame(), so itemView is NOT nullptr
    auto itemView = holder->itemView();
    EXPECT_NE(itemView, nullptr);
}

TEST_F(UT_CollectionHolder, surface_Default_ReturnsNullptr)
{
    // SetUp calls createFrame(), so surface is NOT nullptr
...
{
    // setHiddableTitleBar is a TODO stub in source, always returns false
...
{
    // setHiddableView is a TODO stub in source, always returns false
