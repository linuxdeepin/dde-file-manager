...
TEST_F(ShareWatcherTest, shareRemoved)
{
    // Test method: void shareRemoved((const QString &path))
    QString _arg0{};
    EXPECT_NO_FATAL_FAILURE(obj->shareRemoved(_arg0));
}
