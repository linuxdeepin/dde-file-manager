...
static QAction *odmsFindActionById(QMenu *menu, const QString &actionId)
{
    for (auto act : menu->actions()) {
        if (act->property("actionID").toString() == actionId)
            return act;
    }
    return nullptr;
}
...
TEST_F(UT_OpenDirMenuScene, OpenAsAdminAction_DeveloperModeDisabled_DoesNotAdd)
{
    ...
    EXPECT_EQ(odmsFindActionById(&menu, QString(ActionID::kOpenAsAdmin)), nullptr);
}
...
TEST_F(UT_OpenDirMenuScene, OpenAsAdminAction_AllConditionsMet_AddsAction)
{
    stub.set_lamda(&SysInfoUtils::isDeveloperModeEnabled, []() {
        __DBG_STUB_INVOKE__
        return true;
    ...
    EXPECT_NE(odmsFindActionById(&menu, QString(ActionID::kOpenAsAdmin)), nullptr);
}
...
TEST_F(UT_OpenDirMenuScene, Triggered_OpenInTerminalAction_ReturnsTrue)
{
    stub.set_lamda(&SysInfoUtils::isDeveloperModeEnabled, []() {
        __DBG_STUB_INVOKE__
        return false;
    ...
    QAction *terminalAction = odmsFindActionById(&menu, QString(ActionID::kOpenInTerminal));
    ASSERT_NE(terminalAction, nullptr);
    EXPECT_TRUE(scene->triggered(terminalAction));
}

TEST_F(UT_OpenDirMenuScene, Triggered_SelectAllAction_ReturnsTrue)
{
    stub.set_lamda(&SysInfoUtils::isDeveloperModeEnabled, []() {
        __DBG_STUB_INVOKE__
        return false;
    ...
    QAction *selectAllAction = odmsFindActionById(&menu, QString(ActionID::kSelectAll));
    ASSERT_NE(selectAllAction, nullptr);
    EXPECT_TRUE(scene->triggered(selectAllAction));
}

TEST_F(UT_OpenDirMenuScene, Triggered_OpenAsAdminAction_ReturnsTrue)
{
    stub.set_lamda(&SysInfoUtils::isDeveloperModeEnabled, []() {
        __DBG_STUB_INVOKE__
        return true;
...
TEST_F(UT_OpenDirMenuScene, Triggered_OpenInNewWindowAction_ReturnsTrue)
{
    QVariantHash params;
    params[MenuParamKey::kCurrentDir] = QUrl::fromLocalFile("/tmp");
    params[MenuParamKey::kSelectFiles] = QVariant::fromValue(QList<QUrl> { QUrl::fromLocalFile("/tmp/testdir") });
    ...
    QAction *newWindowAction = odmsFindActionById(&menu, QString(ActionID::kOpenInNewWindow));
