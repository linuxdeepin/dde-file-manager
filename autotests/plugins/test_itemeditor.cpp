...
{
    // Test constructor: ItemEditor((QWidget *parent))
    ASSERT_NE(obj, nullptr);
}

TEST_F(ItemEditorTest, M_~ItemEditor)
{
    // Test method:  ~ItemEditor(())
    EXPECT_NO_FATAL_FAILURE({ ItemEditor *tmp = new ItemEditor(); delete tmp; });
}
...
{
    // Test method: void textChanged(())
    EXPECT_NO_FATAL_FAILURE(obj->textChanged());
}
