...
TEST_F(TitleBarEventCallerTest, SendDetailViewState_Checked_SlotCalled)
{
    ...
    bool capturedUserAction = false;
    quint64 capturedId = 0;

    typedef QVariant (EventChannelManager::*PushFunc)(const QString &, const QString &, quint64, bool &, bool &);
    stub.set_lamda(static_cast<PushFunc>(&EventChannelManager::push),
                   [&](EventChannelManager *, const QString &space, const QString &topic, quint64 id, bool checked, bool userAction) {
                       __DBG_STUB_INVOKE__
    ...
    EXPECT_TRUE(capturedUserAction);   // default userAction = true
}
...
TEST_F(TitleBarEventCallerTest, SendGetDefualtViewMode_FileScheme_ReturnsIconMode)
{
    ...
    ViewMode mode = TitleBarEventCaller::sendGetDefaultViewMode("file");
