...
TEST_F(TestGroupingEngine, GenerateModelData_FailedResult)
{
    ...
    auto modelData = engine->generateModelData(failedResult, expansionStates, QHash<QString, bool>(), nullptr);
...
TEST_F(TestGroupingEngine, GenerateModelData_SuccessResult)
{
    ...
    auto modelData = engine->generateModelData(successResult, expansionStates, QHash<QString, bool>(), nullptr);
...
{
    GroupedModelData oldData;
    MockGroupStrategy strategy("Name");
