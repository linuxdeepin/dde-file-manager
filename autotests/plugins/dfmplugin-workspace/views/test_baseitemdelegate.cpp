...
TEST_F(BaseItemDelegateTest, IconSizeLevel_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
    auto result = delegate->iconSizeLevel();
    EXPECT_EQ(result, -1);
}

TEST_F(BaseItemDelegateTest, MinimumIconSizeLevel_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
...
TEST_F(BaseItemDelegateTest, MaximumIconSizeLevel_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
...
TEST_F(BaseItemDelegateTest, IncreaseIcon_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
...
TEST_F(BaseItemDelegateTest, DecreaseIcon_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
...
TEST_F(BaseItemDelegateTest, SetIconSizeByIconSizeLevel_ValidLevel_ReturnsNegativeOne)
{
    // Base class returns -1 (not implemented)
    int level = 2;
...
{
    // Base class returns empty size if no icon in option
    QStyleOptionViewItem option;
    QModelIndex index;
    QSize size(64, 64);
...
{
    // getGroupHeaderSizeHint uses option.rect.width() which may be 0
    QStyleOptionViewItem option;
